...
public class Dialog extends PageObject{
	...
	public static InsertDocument insertDocument;
	...
	public static class Upload
	{
		...
		public static void upload(int num) {
			action.clickAction("uploader_uploader_Upload");
			util.pause(num);
		}
	...
	public static class UploadDestination
	{
		...
		public static void select(String folder) {
			util.pause(0.5);
			find(folder);
			util.pause(0.5);
			selectFolder(folder);
	...
	public static class NewFolder
	{
		...
		public static void enterFoldersName() {
			...
			action.inputText("newFolderDialog_newFolderDialog", UserAction.currentValue);
		}
	...
	public static class CustomFields
	{
         ...
         {
			 action.inputText("custom-field", "dialogSection", "input", 0, label);
         }
         public static void fieldName(String name)
         {
        	 action.inputText("custom-field", "dialogSection", "input", 1, name);
         }
         public static void align(MetadataOption option)
         {
        	 action.selectDropdown("custom-field","sideComponent", 0, "button", 0 , option.returnOption());
         }
        
         public static void showByDefault()
         {
        	 action.cfClickAction("custom-field", "Show by Default");
         }
         public static void wrapText()
         {
        	 action.cfClickAction("custom-field", "Wrap Text");
         }
        
         public static void columnPosition(MetadataOption option)
         {
        	 action.selectDropdown("custom-field","sideComponent", 1, "button", 0 , option.returnOption());
         }

         public static void showInDocChooser()
         {
        	 action.cfClickAction("custom-field", "Show in Doc Chooser");
         }
         public static void showInSearchResults()
         {
        	 action.cfClickAction("custom-field", "Show in Search Results");
         }
         public static void showInChronologyPreview()
         {
        	 action.cfClickAction("custom-field", "Show in Chronology Preview");
         }
         public static void showOnExportCoverpage()
         {
        	 action.cfClickAction("custom-field", "Show on Export Coverpage");
         }
         public static void showOnTranscriptsPage()
         {
        	 action.cfClickAction("custom-field", "Show on Transcripts Page");
         }
         public static void showOnEPE()
         {
        	 action.cfClickAction("custom-field", "Show on EPE");
         }
         public static void customPageHeader()
         {
        	 action.cfClickAction("custom-field", "Custom Page Header");
         }
         public static void exportFileNameConvention()
         {
        	 action.cfClickAction("custom-field", "Export File Name Convention");
         }
         public static void showInMagnumNotes()
         {
        	 action.cfClickAction("custom-field", "Show in Magnum Notes");
         }
         public static void cancel()
         {
        	 action.clickAction("custom-field_Cancel");
         }
         public static void apply()
         {
	...
	public static class InsertDocument 
	{
		public static void apply()
        {
       	 	action.clickAction("insert-document_Apply");
       	 	util.pause(10);
        }
		public static void cancel()
        {
       	 	action.clickAction("insert-document_Cancel");
        }
		public static void chooseFile() {
			action.clickAction("insert-document_insert-document_Choosefile");
		}
		public static void selectFile(String file) throws AWTException {			
			action.selectFile(file);
		}
		public static void checkbox(String radio)
        {
       	 	action.radio("insert-document_insert-document", radio);
        }
