...
public class Documents  extends PageObject {
	...
	public void uploadDocument() {
		user.clickAction("upload-toggle-button");
	}

	public void newFolder() {
		user.clickAction("docscontrols_NewFolder");
	}
	...
	public void filterByTags(){
		user.clickAction("filter-button-docscontrols");		
	}
	...
	public void createNewFolder(){
		user.clickAction("docscontrols_NewFolder");
		util.pause(0.5);
		user.closeDialog("newFolderDialog dialogClose-div");
	}
	public void createOrEditTags(){
		user.clickAction("docscontrols_Tags");
	}
	public void moveFolderOrTags(){
		user.clickAction("docscontrols_Move");
		util.pause(0.5);
		user.clickAction("docscontrols_Move");
	}
	public void snapshotView(){
		...
		util.pause(0.5);
		user.closeDialog("dialogClose-div");
	}
	public void controlsTools(){
		user.clickAction("docscontrols_Tools");
		util.pause(0.5);		
		dropDownOptions2("admin-button", "element", Constants.BULK_ORGANIZE);
		util.pause(0.5);
		user.closeDialog("add-doc-to-tags-from-id dialogClose-div");
	}
	...
	public void select(ToolsOption option) {
		if ((option.returnToolOption().equals("Bulk Organize")) || (option.returnToolOption().equals("Import Metadata"))){
			user.clickAction("docscontrols_Tools");
			user.select(option, "admin-button");
		}else {
			user.clickAction("docscontrols_Tools");
			user.select(option, "admin-button");
