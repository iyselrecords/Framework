Narrative: 
If the user is logged in and present on the Documents Page where the Add To Menu is open 
they must beable to open the Add To Chronology Dialog by selecting the Chronology option. 

Meta: @OpenAddToChronologyDialogViaAddToMenuDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser
