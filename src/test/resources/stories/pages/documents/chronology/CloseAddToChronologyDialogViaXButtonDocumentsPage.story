...
Meta: @CloseAddToChronologyDialogViaXButtonDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser
...
Scenario: Close Add To Chronology Dialog Via X Button Documents Page
