...
they must beable to close the dialog by clicking the No Button. 

Meta: @CloseTagFolderDialogViaNoButtonDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser @User
...
Scenario: Close Tag Folder Dialog Via No Button Documents Page
