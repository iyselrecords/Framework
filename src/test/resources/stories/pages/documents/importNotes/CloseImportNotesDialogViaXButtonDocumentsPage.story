Narrative: 
If the user is logged in and present on the Documents page where the Import Notes Dialog is open 
they must beable to close the dialog by clicking the X Button. 

Meta: @CloseImportNotesDialogViaXButtonDocumentsPage @MagnumAdmin @Admin
...
Scenario: Close Import Notes Dialog Via X Button Documents Page
