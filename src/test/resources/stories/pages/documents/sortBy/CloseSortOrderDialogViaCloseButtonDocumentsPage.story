...
Meta: @CloseSortOrderDialogViaCloseButtonDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser @User
...
Scenario: Close Sort Order Dialog Via Close Button Documents Page
