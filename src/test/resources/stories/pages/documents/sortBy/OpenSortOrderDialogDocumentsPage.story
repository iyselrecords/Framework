...
they must beable to open the Sort Order Dialog by selecting the Sort By option from the menu. 

Meta: @OpenSortOrderDialogDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser @User
