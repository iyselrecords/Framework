...
Meta: @ClosePageRotationDialogViaXButtonDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser
...
Scenario: Close Page Rotation Dialog Via X Button Documents Page
