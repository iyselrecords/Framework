...
Meta: @CloseInsertDocumentDialogViaXButtonDocumentsPage @MagnumUser @USER_GUI08 @Admin @Power @User
...
Scenario: Close Insert Document Dialog Via X Button Documents Page
