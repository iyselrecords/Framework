...
Meta: @CloseFolderColourDialogViaXButtonDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser 
...
Scenario: Close Folder Colour Dialog Via X Button Documents Page
