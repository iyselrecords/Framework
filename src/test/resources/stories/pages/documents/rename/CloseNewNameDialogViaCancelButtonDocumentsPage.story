...
Meta: @CloseNewNameDialogViaCancelButtonDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser 
...
Scenario: Close New Name Dialog Via Cancel Button Documents Page
