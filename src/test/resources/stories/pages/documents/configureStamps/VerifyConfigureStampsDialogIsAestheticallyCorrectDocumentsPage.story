Narrative: 
The Configure Stamps Dialog is a tool which is used to choose stamps and configure how they should be set up on a Documents Page
...
@Meta: @VerifyConfigureStampsDialogIsAestheticallyCorrectDocumentsPage @MagnumUser @Admin @PowerUser @User
...
Scenario: Open Configure Stamps Dialog Documents Page
...
Scenario: Verify Configure Stamps Dialog Is Aesthetically Correct Documents Page
...
And each of the Buttons, Fields, Icons and Element_Names must be correct on the Configure_Stamps_Dialog