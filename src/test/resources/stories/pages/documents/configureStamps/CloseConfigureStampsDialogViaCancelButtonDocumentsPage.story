Narrative:
If the user is logged in and present on the Documents page where the Configure Stamps Dialog is open 
they must beable to close the dialog by clicking the Cancel Button. 

Meta: @CloseConfigureStampsDialogViaCancelButtonDocumentsPage @MagnumAdmin @Admin
...
Scenario: Close Configure Stamps Dialog Via Cancel Button Documents Page
