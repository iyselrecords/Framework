...
they must beable to open the Relationships Dialog by selecting the Related Documents Option from the menu. 

Meta: @OpenRelationshipsDialogDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser @User
