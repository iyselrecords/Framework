Narrative: 
If the user is logged in and present on the Documents Page where the Relationships Dialog is open
they must beable to close the dialog by clicking the Cancel Button. 

Meta: @CloseRelationshipsDialogViaCancelButtonDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser @User
...
Scenario: Close Relationships Dialog Via Cancel Button Documents Page
