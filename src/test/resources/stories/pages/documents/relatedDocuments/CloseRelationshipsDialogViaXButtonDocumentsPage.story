...
Meta: @CloseRelationshipsDialogViaXButtonDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser @User
...
Scenario: Close Relationships Dialog Via X Button Documents Page
