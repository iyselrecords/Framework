Narrative: 
If the user is logged in, and present on the Documents Page where there is a Document loaded to the Preview Window 
they must beable to open the Page Number Selection Dropdown Menu By clicking the Dropdown Arrow at the side of this menu. 

Meta: @OpenPageNumberSelectionDropdownDocumentPreviewDocumentsPage @MagnumUser @USER_GUI08 @Admin @PowerUser @User
