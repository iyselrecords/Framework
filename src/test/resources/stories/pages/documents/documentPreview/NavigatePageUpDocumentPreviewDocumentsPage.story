...
they must beable to navigate up the pages by clicking the Page Up Arrow. 

Meta: @NavigatePageUpDocumentPreviewDocumentsPage @MagnumUser @USER_FUNCD14 @Admin @PowerUser @User @Viewer
