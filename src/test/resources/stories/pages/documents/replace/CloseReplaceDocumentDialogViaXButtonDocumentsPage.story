...
Meta: @CloseReplaceDocumentDialogViaXButtonDocumentsPage @MagnumUser @Admin @USER_GUI08 @PowerUser @User
...
Scenario: Close Replace Document Dialog Via X Button Documents Page
