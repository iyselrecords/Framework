...
@Meta: @VerifyFolderColourDialogIsAestheticallyCorrectDocumentsPage @MagnumUser @Admin @PowerUser @User @AdminUser @ADMIN_01_10
...
Scenario: Select Settings Disable Memorable Word Option Admin User Page
