...
public class ChronologySteps extends SerenityStories{
	...
	public void whenUserInputchro_date(@Named("chro_date") String date){
		dialog.chronologyFilter.inputDate(date);
	}
	@SuppressWarnings("static-access")
	...
	public void whenUserSelectAll(){
		dialog.chronologyFilter.openDropdown();
	...
	public void whenUserClickSharedFiltersCheckbox(){
		action.clickAction("chron-filter_chron-filter", "saved-filters", "input",0);
	}
	@SuppressWarnings("static-access")
	...
	public void whenUserClickPrivateFiltersCheckbox(){
		action.clickAction("chron-filter_chron-filter", "saved-filters", "input",2);
	}
	@SuppressWarnings("static-access")
